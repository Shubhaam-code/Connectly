...
function NotificationCard({ noti, compact }) {
  ...
  return (
    ...
    <div className={`flex items-center gap-3 p-3 rounded-2xl cursor-pointer hover:bg-white/5 transition-all ${!noti.isRead ? 'bg-purple-950/20' : ''}`}
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs mt-0.5" style={{ color: '#6B7280' }}>Just now</p>
      </div>
