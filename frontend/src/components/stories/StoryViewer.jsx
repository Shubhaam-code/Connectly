...
export const StoriesContainer = ({ stories = [], ownStories = [], onStoryClick, onAddOwnClick }) => {
  ...
  return (
    <div className="w-full bg-[var(--card)]/40 border border-[var(--border)] rounded-3xl p-4 mb-6 shadow-lg select-none">
      <div className="flex gap-3.5 overflow-x-auto py-1 scrollbar-none w-full">
